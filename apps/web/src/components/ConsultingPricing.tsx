      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <a href="https://wa.me/919995959055" target="_blank" rel="noopener noreferrer" className="w-full py-4 bg-slate-700 hover:bg-emerald-600 text-white font-bold rounded-xl transition-colors text-center">
          ...
          >
            ...
            <a href="https://wa.me/919995959055?text=I%20would%20like%20to%20book%20a%2015-min%20call" target="_blank" rel="noopener noreferrer" className="w-full py-4 bg-white text-blue-900 hover:bg-blue-50 font-bold rounded-xl transition-colors text-center">
          ...
          >
            ...
            <a href="https://wa.me/919995959055?text=I%20need%20a%20Loan%20Strategy%20Blueprint" target="_blank" rel="noopener noreferrer" className="w-full py-4 bg-slate-700 hover:bg-purple-600 text-white font-bold rounded-xl transition-colors text-center">
